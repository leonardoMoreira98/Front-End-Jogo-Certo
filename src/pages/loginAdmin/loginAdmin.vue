<template>
    <q-page class="bg-light-green window-height window-width row justify-center items-center">
      <div class="column">
        <div class="row">
          <h5 class="text-h5 text-white q-my-md"><q-icon name="sports_soccer" /> JogoCerto - Admin</h5>
        </div>
        <div class="row">
          <q-card square bordered class="q-pa-lg shadow-1">
            ...
            <q-card-actions class="q-px-md">
              <q-btn unelevated icon="login" color="light-green-7" size="lg" class="full-width" label="Efetuar Login" @click="this.efetuarLogin()"/>
            </q-card-actions>
          </q-card>
        </div>
      </div>
